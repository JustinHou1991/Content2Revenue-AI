    ...
    def _build_result(
        ...
        match_result: Dict[str, Any] = {
            ...
            "content_snapshot": {
                ...
                "hook_keywords": content_feature.get("hook_keywords", [])[:5],
                "topic_tags": content_feature.get("topic_tags", [])[:5],
                "content_category": content_feature.get("content_category"),
                "content_score": content_feature.get("content_score"),
                "cta_type": content_feature.get("cta_type"),
                "emotion_tone": content_feature.get("emotion_tone"),
                "target_audience": content_feature.get("target_audience"),
                "key_selling_points": content_feature.get("key_selling_points", [])[:3],
            },
            "lead_snapshot": {
                "lead_id": lead_id,
                "industry": lead_profile.get("industry"),
                "company_stage": lead_profile.get("company_stage"),
                "role": lead_profile.get("role"),
                "pain_points": lead_profile.get("pain_points", [])[:5],
                "buying_stage": lead_profile.get("buying_stage"),
                "lead_score": lead_profile.get("lead_score"),
                "lead_grade": lead_profile.get("lead_grade"),
                "intent_level": lead_profile.get("intent_level"),
            },
